...
flask_app.config['MONGO_URI']='mongodb+srv://lzr:15221657@cluster0.hk2bc.mongodb.net/present?retryWrites=true&w=majority'
flask_app.config['MONGO_DBNAME']="i_am_present"
